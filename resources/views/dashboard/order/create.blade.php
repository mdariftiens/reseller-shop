                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group focused">
                                                ...
                                                {{ Form::textGroup('total_offer_price', null,'Total Offer Price',['class'=>'form-control net_total_offer_price','readonly'],'','col-md-12') }}
                                            </div>
                                            <div class="form-group focused">
                                                {{ Form::textGroup('total_selling_price', null,'Total Selling Price',['class'=>'form-control net_total_selling_price','readonly'],'','col-md-12') }}

                                            </div>
                                            <div class="form-group focused">
                                                {{ Form::textGroup('total_profit', null,'Total Profit',['class'=>'form-control net_total_profit','readonly'],'','col-md-12') }}
                                            </div>
                                            <div class="form-group focused">
                                                @php
                                                    $options = [
                                                ...
                                                @endphp
                                                {{ Form::selectGroup('delivery_in',$options,50,'Delivery',['class'=>'form-control delivery_in'],'','col-md-12') }}
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $body.on('click','.btn-submit',function (){
                ...
                axios.post('{{ route('order.store') }}', f )
            ...
            function noRowHtml(){
                if ( $body.find('.sl').length===0 ){
                    $body.find('.table-order-detail tbody').html(noRowHtmlVar)
                }
            }
